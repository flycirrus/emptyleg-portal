    ...
    >
      ...
      <div className="flex items-center gap-3 sm:min-w-[320px]">
        <div className="min-w-0">
          <p className="text-base font-semibold text-white">{flight.depCity}</p>
          <p className="text-xs font-medium text-[#c9a96e]">{flight.depAirportIata}</p>
        </div>

        <div className="flex items-center gap-1.5 px-2 text-gray-500">
          <div className="h-px w-6 bg-gray-700" />
          <Plane className="h-4 w-4 shrink-0 text-[#c9a96e]" />
          <div className="h-px w-6 bg-gray-700" />
        </div>

        <div className="min-w-0">
          <p className="text-base font-semibold text-white">{flight.arrCity}</p>
          <p className="text-xs font-medium text-[#c9a96e]">{flight.arrAirportIata}</p>
        </div>
      </div>

      {/* Date & Time */}
      <div className="flex items-center gap-4 text-sm text-gray-400 sm:min-w-[180px]">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span>{formatTime(flight.depDatetimeUtc)} UTC</span>
        </div>
      </div>
